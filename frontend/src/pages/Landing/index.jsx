					...
					<Grid item container direction="column" style={{ padding: "5em 0em" }}>
						<Grid item>
							<Typography align="center" variant="overline" display="block" style={{ padding: "1em" }}>
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad pariatur harum temporibus debitis eius quo magni distinctio, impedit odit illo?
							</Typography>
							<Typography align="center" varient="body1" gutterBottom>
								Lorem, ipsum dolor sit amet adipisicing elit. Quisquam voluptatem itaque maiores voluptate ducimus unde laudantium ipsum, libero magnam sunt.
							</Typography>
						</Grid>
						<Grid item>
							<Typography align="center" varient="body2" gutterBottom>
								Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis dolorem ad expedita blanditiis quisquam minus repudiandae harum nesciunt consequuntur at laboriosam excepturi pariatur officia alias natus libero maxime, sapiente et earum. Id accusamus nesciunt pariatur atque in qui enim ducimus velit, esse, quam excepturi harum aliquid. Sapiente quia esse ad?
							</Typography>
						</Grid>
						<Grid item>
